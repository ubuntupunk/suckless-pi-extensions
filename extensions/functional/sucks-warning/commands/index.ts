...
class SucksWarningStatusOverlay {
  constructor(
  ...
  render(width: number): string[] {
    ...
    // Title
    lines.push(this.renderTitleLine("THIS SUCKS STATUS", innerWidth));
...
export function setupSucksWarningCommands(pi: ExtensionAPI): void {
  pi.registerCommand("sucks-warning-status", {
    description: "Show current 'this sucks' proximity status",
