export const SUCKS_WARNING_MESSAGE = "THIS SUCKS WARNING";
 ...
 * These determine when we're entering the "this sucks" zone based on token usage.
 */
export const CONTEXT_THRESHOLDS = {
  /** Warning threshold - getting close to sucks zone */
  WARNING: 30,

  /** Danger threshold - fully in the sucks zone */
  DANGER: 35,
